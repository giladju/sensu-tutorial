...
Vagrant.configure(2) do |config|
  ...
  config.vm.define :rabbitmq do |rabbit_config|
    ...
    rabbit_config.vm.network "private_network", type: "192.168.50.101"
  ...
  config.vm.define :redis do |redis_config|
    ...
    redis_config.vm.network "private_network", type: "192.168.50.102"
  ...
  config.vm.define :sensu_server do |sensu_server_config|
    ...
    sensu_server_config.vm.network "private_network", type: "192.168.50.103"
  ...
  config.vm.define :sensu_client do |sensu_client_config|
    ...
    sensu_client_config.vm.network "private_network", type: "192.168.50.104"
